...
class NSSLlamaDecoderLayer(LlamaDecoderLayer):
...
class NSSLlamaForCausalLM(LlamaForCausalLM):
    def __init__(self, config: LlamaConfig):
        super().__init__(config)
        self.model = NSSLlamaModel(config=config)
