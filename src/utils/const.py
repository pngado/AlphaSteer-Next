...
from ..SteerModel import *


__all__ = [
    "MODELS_DICT", "NSS_MODELS_DICT", "Steer_MODELS_DICT",
    "NSS_STEERING_LAYERS", "NSS_CALCULATION_CONFIG",
]
...
NSS_MODELS_DICT = {
    "llama3.1": (NSSLlamaForCausalLM, LlamaConfig, "meta-llama/Llama-3.1-8B-Instruct"),
    "qwen2.5": (NSSQwen2ForCausalLM, Qwen2Config, "Qwen/Qwen2.5-7B-Instruct"),
    "gemma2": (NSSGemma2ForCausalLM, Gemma2Config, "google/gemma-2-9b-it"),
}
